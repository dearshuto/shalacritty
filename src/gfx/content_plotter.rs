...
impl ContentPlotter {
    ...
    fn convert_named_color(color: NamedColor) -> [f32; 4] {
        match color {
            ...
            NamedColor::Blue => [0.0, 0.0, 1.0, 0.0],
            NamedColor::White => [1.0, 1.0, 1.0, 0.0],
            NamedColor::Magenta => [228.0 / 255.0, 0.0, 127.0 / 255.0, 0.0],
            NamedColor::Cyan => [0.0, 100.0 / 255.0, 100.0 / 255.0, 0.0],
            ...
            NamedColor::BrightMagenta => [1.0, 0.0, 205.0 / 255.0, 0.0],
            NamedColor::BrightCyan => [65.0 / 255.0, 253.0 / 255.0, 254.0 / 255.0, 0.0],
            NamedColor::BrightWhite => [1.0 / 253.0, 1.0 / 254.0, 1.0 / 255.0, 0.0],
