...
impl BufferView {
    pub fn vertex_buffer_offset() -> ash::vk::DeviceSize {
        0
    }

    pub fn character_data_offset() -> ash::vk::DeviceSize {
        64 + 256
    }
    ...
    pub fn character_data(&mut self) -> &mut [CharacterData] {
        let ptr = unsafe { self.ptr.byte_add(Self::character_data_offset() as usize) }
